...
ascii_cli_name = """
    ___    ____  __  _______  _   ________ __    ________    ____
   /   |  / __ \/  |/  / __ \/ | / /  _/ //_/   / ____/ /   /  _/
  / /| | / /_/ / /|_/ / / / /  |/ // // ,<     / /   / /    / /
 / ___ |/ _, _/ /  / / /_/ / /|  // // /| |   / /___/ /____/ /
/_/  |_/_/ |_/_/  /_/\____/_/ |_/___/_/ |_|   \____/_____/___/
"""
...
def version_callback(ctx: click.Context, param: click.Parameter, value: bool) -> None:
    ...
    console.print(Text("CLI version: ", style="bold white").append(cli_version, style=f"bold {color}"))
    console.print(Text("API version: ", style="bold white").append(api_version, style=f"bold {color}"))
    ctx.exit()
